      ...
      <section className="bg-gradient-to-b from-nourish-50 to-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            Reach out to our team using the form below or contact information.
          </p>
        </div>
      </section>
            ...
            <div>
              <div className="bg-gray-50 p-8 rounded-lg shadow-sm mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-nourish-100 rounded-full p-3 mr-4">
                      <MapPin className="h-6 w-6 text-nourish-600" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-nourish-100 rounded-full p-3 mr-4">
                      <Phone className="h-6 w-6 text-nourish-600" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-nourish-100 rounded-full p-3 mr-4">
                      <Mail className="h-6 w-6 text-nourish-600" />
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-900 mb-1">Email Address</h3>
                      <p className="text-gray-600">hello@nourishnet.org</p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-nourish-100 rounded-full p-3 mr-4">
                      <Clock className="h-6 w-6 text-nourish-600" />
                    </div>
                    <div>
              ...
              <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className="bg-nourish-100 text-nourish-600 hover:bg-nourish-200 h-10 w-10 rounded-full flex items-center justify-center"
                    aria-label="Facebook"
                  >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Visit our headquarters in San Francisco or reach out to us online.
            </p>
          </div>
          
          <div className="rounded-lg overflow-hidden shadow-md h-[400px]">
            {/* For demo purposes, using a placeholder image for the map */}
